...
exec "Snippet ie6hack * html ".st."selector".et." { ".st.et." }".st.et
exec "Snippet ie7hack *+html ".st."selector".et." { ".st.et." }".st.et
exec "Snippet iehack * html ".st."selector".et." { ".st.et." }<CR>*+html ".st."selector".et." { ".st."content".et." }"
exec "Snippet ieibhack * html ".st."selector".et." { display:inline; }<CR><BS><BS>*+html ".st."selector".et." { display:inline; }"
