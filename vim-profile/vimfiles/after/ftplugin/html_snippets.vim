...
exec "Snippet doctype <!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Frameset//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><CR>".st.et
...
exec "Snippet ul2 <ul><CR><li>".st.et."</li><CR><li>".st.et."</li><CR></ul>"
exec "Snippet ul3 <ul><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR></ul>"
exec "Snippet ul4 <ul><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR></ul>"
exec "Snippet ul5 <ul><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR></ul>"
exec "Snippet ul6 <ul><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR></ul>"
exec "Snippet ul7 <ul><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR></ul>"
exec "Snippet ul8 <ul><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR></ul>"
exec "Snippet ul9 <ul><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR><li>".st.et."</li><CR></ul>"
